...
const sobreSkill = [
                    ...
                    '<p>Bootstrap</p> <br> <p>É um framework de front-end que facilita a criação de sites responsivos, oferecendo estilos prontos, componentes e um sistema de grid flexível. </p> <br>'
